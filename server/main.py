...
async def generate_recipe_image(request: ImageRequest):
    ...
    try:
        ...
        # Use Gemini to generate image description
...
- Realistic and authentic looking"""
        ...
        try:
            ...
            # For now, return the description as Gemini doesn't directly generate images
            # In production, you might want to use a dedicated image generation service
            return {
                "success": True,
                "imageUrl": None,
        ...
        return {
            "error": str(error) or "Failed to generate recipe image"
        }
